...
// NBM Transfer ownership of 'ttf_data' to ImFontAtlas, unless font_cfg_template->FontDataOwnedByAtlas == false. Owned TTF buffer will be deleteeted after Build().
...
ImFont::~ImFont()
{
    ...
    // If you want to deleteete fonts you need to do it between Render() and NewFrame().
    // FIXME-CLEANUP
    /*
